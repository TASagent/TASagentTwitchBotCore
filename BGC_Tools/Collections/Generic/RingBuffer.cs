...
namespace BGC.Collections.Generic
{
    ...
    /// </summary>
    public sealed class RingBuffer<T> : IEnumerable<T>, ICollection<T>
    {
        private T[] values = null;
        private int availableCount = 0;
        private int headIndex = -1;

        public bool IsFull => values.Length == availableCount;
    ...
    public sealed class RingBufferEnum<T> : IEnumerator<T>
    {
