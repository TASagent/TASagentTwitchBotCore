...
namespace BGC.Audio
{
    ...
    public static class FrequencyDomain
    {
        ...
        public static int GetComplexFrequencyBin(int bufferSize, double frequency, double samplingRate) =>
           (int)GetComplexFrequencySample(bufferSize, frequency, samplingRate);
