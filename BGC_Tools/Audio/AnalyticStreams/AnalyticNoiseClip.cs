...
public class AnalyticNoiseStream : IAnalyticStream
{
    ...
    public int Read(Complex64[] data, int offset, int count)
    {
        ...
        if (fftBuffer is null)
        {
            throw new Exception($"FFT Buffer was null in read method");
        }
    ...
    private static double GetFactor(AmplitudeDistribution amplitudeDistribution, double frequency)
    {
