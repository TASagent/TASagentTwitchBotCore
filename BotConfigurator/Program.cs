...
namespace BotConfigurator
{
    class Program
    {
        ...
        private static HelixHelper helixHelper;
        private static TokenValidator botTokenValidator;
        private static TokenValidator broadcasterTokenValidator;

        static void Main(string[] args)
        {
            RunConfiguration().Wait();
        }
